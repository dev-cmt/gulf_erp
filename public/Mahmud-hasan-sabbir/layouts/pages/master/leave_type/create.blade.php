                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-6">
                                    ...
                                    <div class="form-group col">
                                        ...
                                        <div class="row-lg">
                                            <input type="text" id="leave_name" class="form-control @error('leave_name') is-invalid @enderror" name="leave_name" value="{{old('leave_name')}}">                                     
                                            @error('leave_name')
                                    ...
                                    <div class="form-group col">
                                        ...
                                        <div class="row-lg">
                                            <input type="text" id="max_limit" class="form-control @error('max_limit') is-invalid @enderror" name="max_limit" value="{{old('max_limit')}}">
                                ...
                                <div class="col-xl-6">
                                    ...
                                    <div class="form-group col">
                                        ...
                                        <div class="row-lg">
                                            <input type="text" id="leave_code" class="form-control @error('leave_code') is-invalid @enderror" name="leave_code" value="{{old('leave_code')}}">   
                                    ...
                                    <div class="form-group col">
                                        ...
                                        <div class="row-lg">
                                            <input type="text" id="yearly_limit" class="form-control @error('yearly_limit') is-invalid @enderror" name="yearly_limit" value="{{old('yearly_limit')}}">
