! function(t, e) {
    ...
    var u = function(t) {
        ...
        r = u("object" == typeof globalThis && globalThis) || u("object" == typeof window && window) || u("object" == typeof self && self) || u("object" == typeof e && e) || function() {
            return this
    ...
    var X = {
        ...
        ct = function(t, e) {
            var n, u = v(t),
                r = 0,
                i = [];
            for (n in u) !m(Y, n) && m(u, n) && i.push(n);
            for (; e.length > r;) m(u, n = e[r++]) && (~ht(i, n) || i.push(n));
            return i
        },
        ...
        Ft = E.f,
        St = function(t, e) {
            var n, u, i, a, s, o = t.target,
                l = t.global,
                h = t.stat;
            if (n = l ? r : h ? r[o] || w(o, {}) : (r[o] || {}).prototype)
                for (u in e) {
        ...
        xt = !wt || i((function() {
            ...
            for (var n = Bt(t), u = arguments.length, r = 1, i = vt.f, s = l.f; u > r;)
                for (var o, h = p(arguments[r++]), c = i ? Dt(h).concat(i(h)) : Dt(h), f = c.length, d = 0; f > d;) o = c[d++], a && !s.call(h, o) || (n[o] = h[o]);
            return n
        } : wt;
    St({
        target: "Object",
    ...
    var ce = function() {
            function t(e, n, u, r) {
                for (Ut(this, t), this.value = e, this.cursorPos = n, this.oldValue = u, this.oldSelection = r; this.value.slice(0, this.startChangePos) !== this.oldValue.slice(0, this.startChangePos);) --this.oldSelection.start
            }
            return Ht(t, [{
                key: "startChangePos",
                get: function() {
            ...
            return Ht(t, [{
                ...
                value: function(e) {
                    if (String(e)) {
                        ...
                        if (e instanceof pe) u ? n.extend(e.toString()) : this.chunks.push(e);
    ...
    var Fe = function(t) {
        ...
        return Ht(n, [{
            ...
            value: function() {
                ...
                for (var r = this.boundaries(e), i = te(r, 2), a = i[0], s = i[1], o = arguments.length, l = new Array(o), h = 0; h < o; h++) l[h] = arguments[h];
        ...
        return Ht(t, [{
            ...
            set: function(t) {
                if (!this.maskEquals(t))
                    if (t instanceof de.Masked || this.masked.constructor !== ke(t)) {
                        var e = ge({
                            mask: t
                        });
