                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-6">
                                    ...
                                    <div class="form-group col">
                                        ...
                                        <div class="row-lg">
                                            <input type="text" id="cat_name" class="form-control @error('cat_name') is-invalid @enderror" name="cat_name" value="{{old('cat_name')}}">  
                                    ...
                                    <div class="form-group col">
                                        ...
                                        <div class="row-lg">
                                            <input type="text" id="description" class="form-control @error('description') is-invalid @enderror" name="description" placeholder="Please Write Something..." value="{{old('description')}}">
                                ...
                                <div class="col-xl-6">
                                    ...
                                    <div class="form-group col">
                                        ...
                                        <div class="row-lg">
                                            <input type="text" id="cat_type" class="form-control @error('cat_type') is-invalid @enderror" name="cat_type" value="{{old('cat_type')}}">
