        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <button type="button" data-toggle="modal"  data-target=".add-modal" class="btn btn-sm btn-success p-1 px-2" ><i class="fa fa-plus"></i></i><span class="btn-icon-add"></span>Add New</button>
                </div>
                <div class="card-body">
            ...
            <form class="form-valide" data-action="{{ route('submit.technician') }}" method="POST" enctype="multipart/form-data" id="add-user-form">
                ...
                <div class="modal-body py-2 px-4">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group row">
                                <label class="col-md-5 col-form-label">Join Date</label>
                                <div class="col-md-7">
                                    <input type="date" name="vat" id="join" class="form-control" value="" disabled>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
