                            ...
                            <div class="row">
                                <div class="col-xl-6">
                                    ...
                                    <div class="form-group col">
                                        ...
                                        <div class="row-lg">
                                            <input type="text" id="cat_name" class="form-control text-capitalize @error('cat_name') is-invalid @enderror" name="cat_name" value="{{old('cat_name')}}" pattern="[a-zA-Z]+.*" title="Cat. name must start with alphabets then others" autofocus required> 
                                            @error('cat_name')
