                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="row mt-1">
                                        ...
                                        <div class="col-md-8">
                                            <select class="dropdwon_select" name="employee_name" id="employeeName" value=""  required>
                                                <option value="">Please select</option>
                                                @foreach ($user as $row)
                                                    <option value="{{ $row->id }}" required>{{ $row->name }} ({{ $row->employee_code->employee_id }})</option>
                                                @endforeach
                                    ...
                                    <div class="row mt-1">
                                        <label class=" col-md-4 col-form-label">Date
                                            <span class="text-danger">*</span>
                                        </label>
                                        <div class="col-md-8">
                                    ...
                                    <div class="row mt-1">
                                       <label for="" class="col-md-4 col-form-label">In Time (hh:mm)
                                        <span class="text-danger">*</span>
                                ...
                                <div class="col-md-6">
                                    <div class="row mt-1">
                                        <label for="" class="col-md-4 col-form-label">Employee Code
                                            <span class="text-danger"></span>
                                        </label>
                                        <div class="col-md-8">
                                            <input type="text" readonly id="employeeCode" class="form-control @error('emp_code') is-invalid @enderror" name="emp_code" placeholder="Enter Employee Code" value="{{old('emp_code')}}">
                                    ...
                                    <div class="row mt-1">
                                        <label for="" class="col-md-4 col-form-label">Attendance Type
                                            <span class="text-danger">*</span>
                                        </label>
                                        <div class="col-md-8">
                                            <select class="form-control" id="att_type" name="attendance_type" required>

                                                <option value="">Please Select attendance type</option>
                                    ...
                                    <div class="row mt-1">
                                        <label for="" class="col-md-4 col-form-label">Out Time (hh : mm )
                                            <span class="text-danger">*</span>
                                        </label>
                                        <div class="col-md-8">
                                ...
                                <div class="col-md-12">
                                    <div class="row mt-1">
                                        ...
                                        <div class="col-md-10">
                                            <textarea  id="" cols="30" rows="1" class="form-control" name="message" placeholder="Please Write Something..." required></textarea>
                                            @error('message')
