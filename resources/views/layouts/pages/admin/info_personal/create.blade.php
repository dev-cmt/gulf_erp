                        ...
                        <div class="row">
                            <div class="col-xl-6">
                                <div class="form-group row">
                                    <label class="col-lg-4 col-form-label">first_name</label>
                                    <div class="col-lg-6">
                                        <input type="text" class="form-control @error('first_name') is-invalid @enderror" id="first_name" name="first_name" placeholder="" value="{{old('first_name')}}">                                     
                                        @error('first_name')
                            ...
                            <div class="col-xl-6">
                                <div class="form-group row">
                                    <label class="col-lg-4 col-form-label">last_name</label>
                                    <div class="col-lg-6">
