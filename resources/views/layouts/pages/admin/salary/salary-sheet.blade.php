        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Salary Sheet List<span class="bg-blue-500 text-white rounded px-1 text-xs py-0.5"></span></h4>
                </div>
                <div class="card-body">
                            ...
                            <div class="col-lg-3 col-sm-12">
                                <div class="mb-3 d-flex">
                                    <div class="form-check mx-1">
                                        ...
                                        <label class="form-check-label" for="check1">Pay-slip</label>
                                    </div>
                                    <button type="submit" class="btn btn-sm btn-secondary mx-1" id="calculate_btn"><i class="ti-save-alt"></i><span class="btn-icon-add"></span>Distribution</button>
                                </div>
                                <div class="mb-3 d-flex">
