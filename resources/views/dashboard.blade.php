        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <a class=" mb-2" href="{{route('login')}}"><i class="bi bi-arrow-right text-primary me-2"></i>Sign In</a>
                    <a class="mb-2" href="{{route('register')}}"><i class="bi bi-arrow-right text-primary me-2"></i>Register</a>
                </div>
                <div class="card-body">
